...
class _ViewQuestionState extends State<ViewQuestion> {
  ...
  Future<void> executePlayQuestionAction(Map<String, dynamic> action) async {
    switch (action['type']) {
      case 'start-recording':
        var page = action['page'];
        _ensureControllersUpTo(page, mySolvepadSize.width);
  ...
  List<List<SolvepadStroke?>> _pickStrokeBucket(String tool, bool isQuestion) {
    switch (tool) {
      case 'DrawingMode.pen':
        return isQuestion ? _questionPenPoints : _penPoints;
      case 'DrawingMode.highlighter':
        return isQuestion ? _questionHighlighterPoints : _highlighterPoints;
      default:
        return isQuestion ? _questionPenPoints : _penPoints;
    }
  }
